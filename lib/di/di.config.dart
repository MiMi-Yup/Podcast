...
import 'package:join_podcast/domain/use_cases/episode_page_usecase.dart'
    as _i48;
import 'package:join_podcast/domain/use_cases/login_page_usecases.dart' as _i51;
...
import 'package:join_podcast/models/episode_model.dart' as _i54;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i43.CreateNewEpisodeCubit>(
        () => _i43.CreateNewEpisodeCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i44.CreateNewPodcastCubit>(
        () => _i44.CreateNewPodcastCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i45.DiscoverPodcastCubit>(
        () => _i45.DiscoverPodcastCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i46.DownloadCubit>(
        () => _i46.DownloadCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i47.EditPodcastCubit>(
        () => _i47.EditPodcastCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i48.EpisodeUseCases>(
        () => _i48.EpisodeUseCases(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i49.HomeCubit>(
        () => _i49.HomeCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i50.ListRecordCubit>(
        () => _i50.ListRecordCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i51.LoginUseCases>(
        () => _i51.LoginUseCases(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i52.NotificationCubit>(
        () => _i52.NotificationCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    gh.factory<_i53.PlayerCubit>(() => _i53.PlayerCubit(
          id: gh<String>(),
          episodeUseCases: gh<_i48.EpisodeUseCases>(),
          episodePlayerManager: gh<_i7.EpisodePlayerManager>(),
          listEpisodes: gh<List<_i54.EpisodeModel>>(),
        ));
    ...
    gh.factory<_i57.PodcastCubit>(
        () => _i57.PodcastCubit(unitOfWork: gh<_i33.UnitOfWork>()));
    ...
    gh.factory<_i63.InitSubscribeCubit>(
        () => _i63.InitSubscribeCubit(usecase: gh<_i51.LoginUseCases>()));
    gh.factory<_i64.InterestCubit>(
        () => _i64.InterestCubit(usecase: gh<_i51.LoginUseCases>()));
    gh.factory<_i65.LibraryCubit>(
        () => _i65.LibraryCubit(usecase: gh<_i55.PlaylistUseCases>()));
    gh.factory<_i66.LoginCubit>(
        () => _i66.LoginCubit(usecase: gh<_i51.LoginUseCases>()));
    gh.factory<_i67.PlaylistCubit>(() => _i67.PlaylistCubit(
