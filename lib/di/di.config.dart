...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i42.CreateNewEpisodeCubit>(
        () => _i42.CreateNewEpisodeCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i43.CreateNewPodcastCubit>(
        () => _i43.CreateNewPodcastCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i44.DiscoverPodcastCubit>(
        () => _i44.DiscoverPodcastCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i45.DownloadCubit>(
        () => _i45.DownloadCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i46.EditPodcastCubit>(
        () => _i46.EditPodcastCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i47.EpisodeUseCases>(
        () => _i47.EpisodeUseCases(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i48.HomeCubit>(
        () => _i48.HomeCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i49.ListRecordCubit>(
        () => _i49.ListRecordCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i50.LoginUseCases>(
        () => _i50.LoginUseCases(unitOfWork: gh<_i32.UnitOfWork>()));
    ...
    gh.factory<_i56.RecordPageCubit>(
        () => _i56.RecordPageCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i57.ResetAccountCubit>(() => _i57.ResetAccountCubit(
          usecase: gh<_i50.LoginUseCases>(),
          token: gh<String>(),
        ));
    gh.factory<_i58.SearchCubit>(
        () => _i58.SearchCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i59.SetInfoPodcastCubit>(
        () => _i59.SetInfoPodcastCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i60.SubscriptionCubit>(
        () => _i60.SubscriptionCubit(unitOfWork: gh<_i32.UnitOfWork>()));
    gh.factory<_i61.InitSubscribeCubit>(
        () => _i61.InitSubscribeCubit(usecase: gh<_i50.LoginUseCases>()));
    gh.factory<_i62.InterestCubit>(
        () => _i62.InterestCubit(usecase: gh<_i50.LoginUseCases>()));
    gh.factory<_i63.LibraryCubit>(
        () => _i63.LibraryCubit(usecase: gh<_i53.PlaylistUseCases>()));
    gh.factory<_i64.LoginCubit>(
        () => _i64.LoginCubit(usecase: gh<_i50.LoginUseCases>()));
    gh.factory<_i65.PlaylistCubit>(() => _i65.PlaylistCubit(
